...
def scrap_stock_data(symbol, exchange):
    if exchange.upper() == 'NASDAQ':
        ...
        try:
            ...
            week_52_low = soup.find_all("span", class_="primary")[4].text
            week_52_high = soup.find_all("span", class_="primary")[5].text
            market_cap = soup.find_all("span", class_="primary")[9].text
            pe_ratio = soup.find_all("span", class_="primary")[14].text
            dividend_yield = soup.find_all("span", class_="primary")[17].text
